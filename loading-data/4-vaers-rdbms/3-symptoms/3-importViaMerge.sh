...
mongoimport $MDB_CONNECT_URI --db=VAERS --collection=data --type=csv --headerline --file=$RECODED_FILE --ignoreBlanks --mode=merge --upsertFields=VAERS_ID --useArrayIndexFields
